...
class BookLibraryTest {
    ...
    void shouldShowAListOfAvailableBooks() {
        ...
        List<String> actualBooks = bookLibrary.showItems();
    ...
    void shouldLetUserCheckoutABook() {
        ...
        bookLibrary.checkOutItem(book2);
        List<String> actualBooks = bookLibrary.showItems();
    ...
    void shouldNotifyUserWhenABookIsSuccessfullyCheckedOut() {
        ...
        String actualMessage = bookLibrary.checkOutItem(book);
    ...
    void shouldNotifyUserWhenABookIsSuccessfullyReturned() {
        ...
        bookLibrary.checkOutItem(book);
        String actualMessage = bookLibrary.returnItem(book);
